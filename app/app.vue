...
const tasks = ref<Task[]>([
  { id: 1, title: 'Read existing codebase structure', category: 'Docs', completed: true },
  { id: 2, title: 'Fix reactivity bug in user list', category: 'Bug', completed: false },
  { id: 3, title: 'Add search filter to dashboard', category: 'Feature', completed: false }
])
...
<template>
  <main style="max-width: 600px; margin: 40px auto; font-family: sans-serif;">
    ...
    <form @submit.prevent="addTask" style="display: flex; gap: 8px; margin-bottom: 20px;">
      <input 
    ...
    <ul style="list-style: none; padding: 0;">
      <li 
        ...
        :key="task.id"
        style="display: flex; justify-content: space-between; padding: 8px; border-bottom: 1px solid #ccc;"
      >
